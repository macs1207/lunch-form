...
if ($day == "2")
{
	...
	for ($i=0; $i<=9; $i++) {
		if ($two[$i] != "") {
			...
			$sql = "INSERT INTO week4 (user, name, price, day, userid) VALUES ('$user', '$name', '$price', '$day' , '$no')";
			if (mysqli_query($conn, $sql)) {
				echo "<script type='text/javascript'>";
				echo "window.location.href='/order/order4.php'";
				echo "</script>";
			} else {
...
if ($day == "1")
{
	...
	for ($i=0; $i<=9; $i++) {
		if ($one[$i] != "") {
			...
			if ($t == "1" || $t == "2") {
				$price = "時價";
				$sql = "INSERT INTO week4 (user, name, price, day, userid) VALUES ('$user', '$name[$t]', '$price', '$day', '$no')";
				if (mysqli_query($conn, $sql)) {
					echo "<script type='text/javascript'>";
					echo "window.location.href='/order/order4.php'";
					echo "</script>";
