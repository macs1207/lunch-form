		...
		<!-- Header -->
			<section id="header">
				<header>
					...
					<h1 id="logo"><a href="#">第一週已點餐點</a></h1>
					<p></p>
				</header>
				<nav id="nav">
					<ul>
						<li><a href="/order/order1.php" class="active">第一週&nbsp;&nbsp;0719-0721</a></li>
				...
				<footer>
                	<li><a href="/order/week1.php" class="button fit">點餐</a></li>
...
<?php
	...
	echo "</nav>";
	echo "<footer>";
	echo "<li><a href=\"/order/week1.php\" class=\"button fit\">點餐</a></li>";
