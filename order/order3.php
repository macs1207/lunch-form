		...
		<!-- Header -->
			<section id="header">
				<header>
					...
					<h1 id="logo"><a href="#">第三週已點餐點</a></h1>
					<p></p>
				</header>
				<nav id="nav">
					<ul>
						...
						<li><a href="/order/order3.php" class="active">第三週&nbsp;&nbsp;0731-0804</a></li>
						<li><a href="/order/order4.php">第四週</a></li>
                        <li><a href="/order/order5.php">第五週</a></li>
					</ul>
				</nav>
				<footer>
                	<li><a href="/order/week3.php" class="button fit">點餐</a></li>
...
<?php
	...
	echo "</nav>";
	echo "<footer>";
	echo "<li><a href=\"/order/week3.php\" class=\"button fit\">點餐</a></li>";
