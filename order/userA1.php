    ...
    for(var i=0;i<checkboxs.length;i++){checkboxs[i].checked = obj.checked;} 
		...
		<!-- Header -->
			<section id="header">
				...
				<nav id="nav">
					<ul>
						<li><a href="/order/userA1.php" class="active">第一週</a></li>
						<li><a href="/order/userA2.php">第二週</a></li>
						<li><a href="/order/userA3.php">第三週</a></li>
						<li><a href="/order/userA4.php">第四週</a></li>
					</ul>
				</nav>
				<footer>
                	<li><a href="/order/itemA1.php" class="button fit">項目排列</a></li>
				</footer>
			</section>
		<!-- Wrapper -->
			<div id="wrapper">
								...
								<div class="container">
									<header class="major">
										...
										<p>
                                            <?php
											$day = "3";
											$sql1 = "SELECT * FROM user1 WHERE class='1' ORDER BY no";
											$result1 = $conn->query($sql1);
											$price = 0;
											$none = "";
											if ($result1->num_rows > 0) {
                            ...
                            <section>
                  				<div class="container">
									<header class="major">
                                        ...
                                        <div id="total">
                                        	<?php
                                            $sql = "SELECT userid, price$week FROM price WHERE userid<'413201' ORDER BY userid";
											$result = $conn->query($sql);
