	...
	if(traget.style.display=="none"){
		...
		<!-- Header -->
			<section id="header">
				...
				<nav id="nav">
					<ul>
						<li><a href="/order/week1.php" class="active">第一週&nbsp;&nbsp;0719-0721</a></li>
...
<?php
	...
	echo "<header>";
	echo "<h1 id=\"logo\"><a href=\"#\">第一週已點餐點</a></h1>";
	echo "<p></p>";
	echo "</header>";
	echo "<nav id=\"nav\">";
	echo "<ul>";
	echo "<li><a href=\"/order/order1.php\" class=\"active\">第一週</a></li>";
	...
	echo "</nav>";
	echo "<footer>";
	echo "<li><a href=\"/order/order1.php\" class=\"button fit\">已點餐點</a></li>";
