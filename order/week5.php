				...
				<nav id="nav">
					<ul>
						...
						<li><a href="/order/week4.php">第四週</a></li>
   						<li><a href="/order/week5.php" class="active">第五週&nbsp;&nbsp;0814-0815</a></li>
					</ul>
				</nav>
				<footer>
                	<li><a href="/order/order5.php" class="button fit">已點餐點</a></li>
...
<?php
	...
	echo "<header>";
	echo "<h1 id=\"logo\"><a href=\"#\">第五週已點餐點</a></h1>";
	echo "<p></p>";
	echo "</header>";
	echo "<nav id=\"nav\">";
	echo "<ul>";
	...
	echo "<li><a href=\"/order/order5.php\" class=\"active\">第五週</a></li>";
	echo "</ul>";
	echo "</nav>";
	echo "<footer>";
	echo "<li><a href=\"/order/order5.php\" class=\"button fit\">已點餐點</a></li>";
