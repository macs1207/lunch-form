		...
		<!-- Header -->
			<section id="header">
				<header>
					...
					<h1 id="logo"><a href="#">第五週已點餐點</a></h1>
					<p></p>
				</header>
				<nav id="nav">
					<ul>
						<li><a href="/order/order1.php">第一週</a></li>
						<li><a href="/order/order2.php">第二週</a></li>
						<li><a href="/order/order3.php">第三週</a></li>
						<li><a href="/order/order4.php">第四週</a></li>
                        <li><a href="/order/order5.php" class="active">第五週&nbsp;&nbsp;0814-0815</a></li>
					</ul>
				</nav>
				<footer>
                	<li><a href="/order/week5.php" class="button fit">點餐</a></li>
...
<?php
	...
	echo "</nav>";
	echo "<footer>";
	echo "<li><a href=\"/order/week5.php\" class=\"button fit\">點餐</a></li>";
