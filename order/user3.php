    ...
    for(var i=0;i<checkboxs.length;i++){checkboxs[i].checked = obj.checked;} 
		...
		<!-- Header -->
			<section id="header">
				<header>
                	<h2>管理頁</h2>
					<h1 id="logo"><a href="#">第三週用戶排列</a></h1>
					<p></p>
				</header>
				<nav id="nav">
					<ul>
						<li><a href="/order/user1.php">第一週</a></li>
						<li><a href="/order/user2.php">第二週</a></li>
						<li><a href="/order/user3.php" class="active">第三週</a></li>
						<li><a href="/order/user4.php">第四週</a></li>
					</ul>
				</nav>
				<footer>
                	<li><a href="/order/item3.php" class="button fit">項目排列</a></li>
