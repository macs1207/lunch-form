...
if (isset($_SESSION["user"])) {
	...
	if($_SESSION["class"]=="1") $choice = "2";
	else if($_SESSION["class"]=="2") $choice = "1";
	$week = "2";
?>
<script>
function display(id){
		...
		<!-- Header -->
			<section id="header">
				<header>
					...
					<h1 id="logo"><a href="#">第二週</a></h1>
					<p></p>
				</header>
				<nav id="nav">
					<ul>
						<li><a href="/order/week1.php">第一週</a></li>
						<li><a href="/order/week2.php" class="active">第二週&nbsp;&nbsp;0727-0728</a></li>
				...
				<footer>
                    <li><a href="/order/order2.php" class="button fit">已點餐點</a></li>
...
<?php
	...
	echo "<header>";
	echo "<h1 id=\"logo\"><a href=\"#\">第二週已點餐點</a></h1>";
	echo "<p></p>";
	echo "</header>";
	echo "<nav id=\"nav\">";
	echo "<ul>";
	echo "<li><a href=\"/order/order1.php\">第一週</a></li>";
	echo "<li><a href=\"/order/order2.php\" class=\"active\">第二週</a></li>";
	...
	echo "</nav>";
	echo "<footer>";
	echo "<li><a href=\"/order/order2.php\" class=\"button fit\">已點餐點</a></li>";
