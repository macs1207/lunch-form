		...
		<!-- Header -->
			<section id="header">
				<header>
					...
					<h1 id="logo"><a href="#">第四週已點餐點</a></h1>
					<p></p>
				</header>
				<nav id="nav">
					<ul>
						...
						<li><a href="/order/order4.php" class="active">第四週&nbsp;&nbsp;0807-0811</a></li>
                        <li><a href="/order/order5.php">第五週</a></li>
					</ul>
				</nav>
				<footer>
                	<li><a href="/order/week4.php" class="button fit">點餐</a></li>
...
<?php
	...
	echo "</nav>";
	echo "<footer>";
	echo "<li><a href=\"/order/week4.php\" class=\"button fit\">點餐</a></li>";
